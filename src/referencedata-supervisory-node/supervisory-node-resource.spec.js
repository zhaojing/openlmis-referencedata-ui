...
describe('SupervisoryNodeResource', function() {
    ...
    beforeEach(function() {
        ...
        var SupervisoryNodeResource;
        inject(function($injector) {
            SupervisoryNodeResource = $injector.get('SupervisoryNodeResource');
        });

        new SupervisoryNodeResource();
    });

    it('should extend OpenlmisResource', function() {
        expect(this.OpenlmisResourceMock).toHaveBeenCalledWith('/api/supervisoryNodes');
    });
});