...
(function() {
    ...
    SupervisoryNodeResource.inject = ['OpenlmisResource', 'classExtender'];

    function SupervisoryNodeResource(OpenlmisResource, classExtender) {

        classExtender.extend(SupervisoryNodeResource, OpenlmisResource);

        return SupervisoryNodeResource;

        function SupervisoryNodeResource() {
