...
(function(){
    ...
    /**
     * @ngdoc service
     * @name referencedata-requisition-group.requisitionGroupFactory
     *
     * @description
    ...
    function factory($q, referencedataRoleService) {
        ...
        return {
            searchWithFacilityInfo: searchWithFacilityInfo
        };

        /**
         * @ngdoc method
         * @methodOf referencedata-requisition-group.requisitionGroupFactory
         * @name getAllWithType
         *
         * @description
