...
(function() {
    ...
    /**
     * @ngdoc service
     * @name referencedata-orderable.OrderableRepositoryImpl
     *
     * @description
     * Implementation of the OrderableRepository interface. Communicates with the REST API of the OpenLMIS server.
     */
    angular
        .module('referencedata-orderable')
        .factory('OrderableRepositoryImpl', OrderableRepositoryImpl);
