...
describe('SystemNotificationResource', function() {
    ...
    it('should extend OpenlmisResource', function() {
        new this.SystemNotificationResource();

        expect(this.OpenlmisResourceMock).toHaveBeenCalledWith('/api/systemNotifications');
    });
});